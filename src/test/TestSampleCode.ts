  ...
  runTests() {
    describe("Test sample code", function() {
      ...
      it("Sample code demonstration", async function() {
        ...
        // connect to daemon
        let daemon: MoneroDaemonRpc = await monerojs.connectToDaemonRpc("http://localhost:38081", "superuser", "abctesting123");
        ...
        let walletRpc: MoneroWalletRpc = await monerojs.connectToWalletRpc("http://localhost:38084", "rpc_user", "abc123");
        ...
        let walletFull: MoneroWalletFull = await monerojs.createWalletFull({
        ...
        await walletFull.addListener(new class extends monerojs.MoneroWalletListener {
          onOutputReceived(output: MoneroOutputWallet) {
      ...
      it("Test developer guide send funds", async function() {
        ...
        let wallet: MoneroWalletFull = await monerojs.createWalletFull({
