...
declare class HttpClient {
     ...
     */
    static _getHttpAgent(): import("http").Agent;
    /**
     ...
     */
    static _getHttpsAgent(): import("https").Agent;
...
declare namespace HttpClient {
    ...
    const _PROMISE_THROTTLES: any[];
    const _TASK_QUEUES: any[];
    const _DEFAULT_TIMEOUT: number;
}
