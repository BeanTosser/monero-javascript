...
class HttpClient {
   ...
   * @param {string} [request.username] - username to authenticate the request 
   * @param {string} [request.password] - password to authenticate the request 
   * @param {object} [request.headers] - headers to add to the request 
