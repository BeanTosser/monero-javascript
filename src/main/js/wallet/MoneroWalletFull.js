...
class MoneroWalletFull extends MoneroWalletKeys {
   ...
   * @param {Uint8Array} [configOrPath.cacheData] - wallet cache data to open 
   * @param {string} [configOrPath.serverUri] - uri of the wallet's daemon 
   * @param {string} [configOrPath.serverUsername] - username to authenticate with the daemon 
   * @param {string} [configOrPath.serverPassword] - password to authenticate with the daemon 
   * @param {boolean} [configOrPath.rejectUnauthorized] - reject self-signed server certificates if true (default true)
   * @param {MoneroRpcConnection|object} [configOrPath.server] - MoneroRpcConnection or equivalent JS object configuring the daemon connection 
   ...
   * @param {string} [config.serverUri] - uri of the wallet's daemon 
