...
declare class MoneroWalletFull extends MoneroWalletKeys implements MoneroWallet {
    ...
    static _sanitizeTxWallet(tx: any): MoneroTxWallet;
     ...
     */
    constructor(cppAddress: number, path: string, password: string, fs: FileSystem, rejectUnauthorized: boolean, rejectUnauthorizedFnId: string);
    _path: string;
    _password: string;
    _listeners: any[];
    _fs: any;
     ...
     */
    sync(listenerOrStartHeight?: MoneroWalletListener | number, startHeight?: number, allowConcurrentCalls?: boolean): Promise<any>;
...
declare class WalletFullListener {
    ...
    onOutputReceived(height: any, txHash: any, amountStr: any, accountIdx: any, subaddressIdx: any, version: any, unlockHeight: any, isLocked: any): Promise<void>;
    onOutputSpent(height: any, txHash: any, amountStr: any, accountIdxStr: any, subaddressIdxStr: any, version: any, unlockHeight: any, isLocked: any): Promise<void>;
}
