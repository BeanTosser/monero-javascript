...
declare class MoneroTxQuery extends MoneroTxWallet {
    ...
    copy(): MoneroTxQuery;
    setIsIncoming(isIncoming: any): MoneroTxQuery;
    setIsOutgoing(isOutgoing: any): MoneroTxQuery;
    getHashes(): any;
    setHashes(hashes: any): MoneroTxQuery;
    setHash(hash: any): MoneroTxQuery;
    hasPaymentId(): any;
    setHasPaymentId(): MoneroTxQuery;
    getPaymentIds(): any;
    setPaymentIds(paymentIds: any): MoneroTxQuery;
    setPaymentId(paymentId: any): MoneroTxQuery;
    ...
    getInputQuery(): any;
    setInputQuery(inputQuery: any): MoneroTxQuery;
    getOutputQuery(): any;
